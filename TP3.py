# REQUIREMENT 3 (09/01/2025): 
# a) Constuct adjacent Matrix for graph G 
#       G = [{1,2};{1,3};{2,5};{2,6};{3,4};{4,8};{5,7}]
# b) Write Inorder algorithm to exploit tree G which obey behaviors:
#       - Input node label (x)
